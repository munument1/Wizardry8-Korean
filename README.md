...
- Wizardry 8
- 원본 1.24: `Wizardry8_KoreanPatch_1.24_TopicFix_v0.2.7.zip`
- Fan Patch 1.28 build 6735: `Wizardry8_KoreanPatch_1.28_TopicFix_v0.2.7.zip`
- 한국어 패치 v0.2.7 (기본 대화 토픽 복원)
...
2. 사용 중인 게임 버전에 맞는 [v0.2.7 릴리스](../../releases)의 ZIP 하나를 받습니다.
